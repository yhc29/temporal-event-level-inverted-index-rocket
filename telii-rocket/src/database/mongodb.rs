...
impl MongoRepo {
    pub fn init() -> Self {
        ...
        let event_col: Collection<Event> = db.collection("event_v3_g89_1");
        let temporal_relation_col: Collection<Document> = db.collection("tree_v3_g89_1");
        let data_col: Collection<Document> = db.collection("tree_tii_v3_g89_1");
